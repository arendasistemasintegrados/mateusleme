...
class FolhaPagamentosController extends AppController {
	...
	/**
	 * Renderiza a view simplificada para mostrar os dados dos servidores
	 */
	 ...
	 *        	integer - $iAno - Ano
	 * @param
	 *        	integer - $iInstituicao - ID da instituicao
	 ...
	 *        	intefer - $iMes - Mes
	 * @param
	 *        	integer - $iInstituicao - ID da instituição
	...
	public function view($iMovimentacaoId) {
		...
		$this->set ( array (
				'aServidorMovimentacao',
				'aLegendaFolhaPagamento' 
		), array (
				$aServidorMovimentacao,
				$aLegendaFolhaPagamento 
		) );
