...
class CakePtbrFormatacaoCase extends CakeTestCase {
	...
	function testData() {
		...
		$this->assertEqual ( $this->Formatacao->data ( 'errado', array (
				'invalid' => 'Inválido' 
		) ), 'Inválido' );
		$this->assertEqual ( $this->Formatacao->data ( strtotime ( '2009-04-21 00:00:00 GMT' ), array (
				'userOffset' => '-1' 
		) ), '20/04/2009' );
	}
	...
	function testDataHora() {
		...
		$this->assertEqual ( $this->Formatacao->dataHora ( 'errado', true, array (
				'invalid' => 'Inválido' 
		) ), 'Inválido' );
		$this->assertEqual ( $this->Formatacao->dataHora ( strtotime ( '2009-04-21 10:20:30 GMT' ), false, array (
				'userOffset' => '+2' 
		) ), '21/04/2009 12:20' );
		$this->assertEqual ( $this->Formatacao->dataHora ( strtotime ( '2009-04-21 10:20:30 GMT' ), false, array (
				'userOffset' => '-2' 
	...
	function testMoeda() {
		...
		$this->assertEqual ( $this->Formatacao->moeda ( - 0.12, array (
				'negative' => '-' 
		) ), 'R$ -0,12' );
