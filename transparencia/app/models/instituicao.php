...
class Instituicao extends AppModel {
	...
	public function getInstituicoesServidores() {
		return $this->find ( 'list', array (
				...
				'order' => 'descricao',
				'conditions' => array (
						'exists (select *                                                              ' . '        from servidores sr                                                  ' . '             inner join servidor_movimentacoes mv on mv.servidor_id = sr.id ' . '       where sr.instituicao_id = "Instituicao"."id")                        ' 
				) 
		) );
	}
	
	/**
	 * Retorna as instiuicoes utilizadas nos acordos
	 * 
	 * @return array
	 */
