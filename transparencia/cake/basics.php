 ...
 * Takes optional number of parameters.
 *
 * Example:
 *
 * `uses('flay', 'time');`
 ...
 *        	If set to true, the method prints the debug data in a screen-friendly way.
...
if (! function_exists ( 'array_combine' )) {
	 ...
	 * and the second one's values as values.
	 * (Implemented for backwards compatibility with PHP4)
	 *
	 * @param array $a1
	 *        	Array to use for keys
	 * @param array $a2
	 *        	Array to use for values
 ...
 *
 * @param string $path
 *        	path within /tmp to save the file.
 * @param mixed $data
 *        	data to save to the temporary file.
 * @param mixed $expires
 ...
 *        	Set to true to return translated string, or false to echo
 ...
 *
 * @param string $data
 *        	Data to set in query string
 * @param string $prefix
 *        	If numeric indices, prepend this to index for elements in base array.
 * @param string $argSep
 *        	String used to separate arguments
...
/**
 * Wraps ternary operations.
 * If $condition is a non-empty value, $val1 is returned, otherwise $val2.
 ...
 * @param mixed $val1
 *        	Value to return in case condition matches
 * @param mixed $val2
 *        	Value to return if condition doesn't match
