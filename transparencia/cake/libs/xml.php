...
class XmlNode extends Object {
	...
	/**
	 * Debug method.
	 * Deletes the parent. Also deletes this node's children,
...
class Xml extends XmlNode {
	...
	/**
	 * Constructor.
	 * Sets up the XML parser with options, gives it this object as
	 ...
	 *
	 * @param mixed $input
	 *        	The content with which this XML document should be initialized. Can be a
	...
	/**
	 * Initialize XML object from a given XML string.
	...
	function parse() {
		...
		$this->__header = trim ( str_replace ( array (
				'<' . '?',
				'?' . '>' 
		), array (
				'',
	 ...
	 *
	 * @param mixed $options
	 *        	If boolean: whether to include the XML header with the document
...
class XmlTextNode extends XmlNode {
	 ...
	 *
	 * @param object $parent
	 *        	Parent XmlNode/XmlElement object
	 * @param mixed $value
	 *        	Node value
	 */
...
class XmlManager {
	 ...
	 * Used in all XML documents processed by this application
	 *
	 * @var array
	 * @access public
	 */
