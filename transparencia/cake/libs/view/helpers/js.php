...
class JsHelper extends AppHelper {
	...
	/**
	 * Workaround for Object::Object() existing.
	 * Since Object::object exists, it does not
...
class JsBaseEngineHelper extends AppHelper {
	...
	function serializeForm() {
		trigger_error ( sprintf ( __ ( '%s does not have serializeForm() implemented', true ), get_class ( $this ) ), E_USER_WARNING );
	}
