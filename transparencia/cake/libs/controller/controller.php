...
class Controller extends Object {
	...
	/**
	 * Data POSTed to the controller using the HtmlHelper.
	 * Data here is accessible
	...
	/**
	 * The output of the requested action.
	 * Contains either a variable
	...
	/**
	 * Contains a list of the HTTP codes that CakePHP recognizes.
	 * These may be
	...
	/**
	 * Convenience and object wrapper method for header().
	 * Useful when doing tests and
	 ...
	 * @param
	 *        	mixed Any other parameters passed to this method will be passed as
	...
	function isAuthorized() {
		trigger_error ( sprintf ( __ ( '%sController::isAuthorized() is not defined.', true ), $this->name ), E_USER_WARNING );
		return false;
	}
