...
class RequestHandlerComponent extends Object {
	 ...
	 * request types.
	 * Can be modified with RequestHandler::setContent()
	 *
	 * @var array
	 * @access private
	 ...
	 * If extension parsing is enabled in the
	 ...
	 * @param
	 *        	mixed HTTP Status for redirect
	 * @access public
	 */
	 ...
	 * If DEBUG is greater than 2, the header
	 * is not set.
	 *
	 * @param mixed $type
