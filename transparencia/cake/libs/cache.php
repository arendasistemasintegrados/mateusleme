...
class Cache {
	 ...
	 * if no params are passed, resets settings if needed
	 ...
	 *        	How much to add
	 * @param string $config
	 *        	Optional string configuration name. If not specified the current
