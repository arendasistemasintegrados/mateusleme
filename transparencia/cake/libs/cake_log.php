 ...
 * One or more adapters can be configured
...
class CakeLog {
	...
	function _getLogger($loggerName) {
		...
		if (! is_callable ( array (
			...
			trigger_error ( sprintf ( __ ( 'logger class %s does not implement a write method.', true ), $loggerName ), E_USER_WARNING );
			return false;
		}
		return $loggerName;
	}
	 ...
	 * catch using `Configure::write('log', $value)`.
	 * See core.php for more information.
	 *
	 *
	 * @param integer $code
	 *        	Code of error
