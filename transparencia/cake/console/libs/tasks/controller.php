...
class ControllerTask extends BakeTask {
	...
	function __interactive() {
		...
		if (strtolower ( $doItInteractive ) == 'y') {
			$this->interactive = true;
			$useDynamicScaffold = $this->in ( __ ( "Would you like to use dynamic scaffolding?", true ), array (
					'y',
					'n' 
			), 'n' );
			...
			if (strtolower ( $useDynamicScaffold ) == 'y') {
				...
				$wannaUseSession = $this->in ( __ ( "Would you like to use Session flash messages?", true ), array (
						'y',
						'n' 
				), 'y' );
			}
		...
		if ($this->interactive === true) {
			...
			$looksGood = $this->in ( __ ( 'Look okay?', true ), array (
					'y',
					'n' 
			), 'y' );
	...
	function _askAboutMethods() {
		$wannaBakeCrud = $this->in ( __ ( "Would you like to create some basic class methods \n(index(), add(), view(), edit())?", true ), array (
				'y',
				'n' 
		), 'n' );
		$wannaBakeAdminCrud = $this->in ( __ ( "Would you like to create the basic class methods for admin routing?", true ), array (
				'y',
				'n' 
		), 'n' );
		return array (
	...
	function doComponents() {
		return $this->_doPropertyChoices ( __ ( "Would you like this controller to use any components?", true ), __ ( "Please provide a comma separated list of the component names you'd like to use.\nExample: 'Acl, Security, RequestHandler'", true ) );
	}
	 ...
	 *        	Whether you are using listAll interactively and want options output.
