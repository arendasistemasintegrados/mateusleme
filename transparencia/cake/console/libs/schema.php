...
class SchemaShell extends Shell {
	...
	function __create(&$Schema, $table = null) {
		...
		if ('y' == $this->in ( __ ( 'Are you sure you want to drop the table(s)?', true ), array (
				'y',
				'n' 
		), 'n' )) {
		...
		if ('y' == $this->in ( __ ( 'Are you sure you want to create the table(s)?', true ), array (
				'y',
				'n' 
		), 'y' )) {
	...
	function __update(&$Schema, $table = null) {
		...
		if ('y' == $this->in ( __ ( 'Are you sure you want to alter the tables?', true ), array (
				'y',
				'n' 
		), 'n' )) {
			$this->out ();
