...
Mock::generate ( 'Object', 'ComponentMockComponent', array (
		'startup',
		'beforeFilter',
		'beforeRender',
		'other' 
...
class ComponentTest extends CakeTestCase {
	...
	function testComponentsWithParams() {
		...
		$this->assertEqual ( $Controller->Orange->settings, array (
				'colour' => 'blood orange' 
		) );
	...
	function testSomethingReferencingEmailComponent() {
		...
		$this->assertTrue ( is_a ( $Controller->SomethingWithEmail, 'SomethingWithEmailComponent' ) );
		$this->assertTrue ( is_a ( $Controller->SomethingWithEmail->Email, 'EmailComponent' ) );
		$this->assertTrue ( is_a ( $Controller->SomethingWithEmail->Email->Controller, 'ComponentTestController' ) );
	}
	...
	function testDoubleLoadingOfSessionComponent() {
		...
		$this->assertEqual ( $Controller->components, array (
				'Session' => '',
				'Orange' => array (
						'colour' => 'blood orange' 
				) 
