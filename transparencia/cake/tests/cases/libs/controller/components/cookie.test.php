...
class CookieComponentTest extends CakeTestCase {
	...
	function testSettingEncryptedCookieData() {
		$this->Controller->Cookie->write ( 'Encrytped_array', array (
				'name' => 'CakePHP',
				'version' => '1.2.0.x',
				'tag' => 'CakePHP Rocks!' 
		) );
	...
	function testSettingPlainCookieData() {
		$this->Controller->Cookie->write ( 'Plain_array', array (
				'name' => 'CakePHP',
				'version' => '1.2.0.x',
				'tag' => 'CakePHP Rocks!' 
		), false );
	...
	function testWritePlainCookieArray() {
		$this->Controller->Cookie->write ( array (
				'name' => 'CakePHP',
				'version' => '1.2.0.x',
				'tag' => 'CakePHP Rocks!' 
		), null, false );
	...
	function testReadingCookieDataOnStartup() {
		...
		$_COOKIE ['CakeTestCookie'] = array (
				'Encrytped_array' => $this->__encrypt ( array (
						'name' => 'CakePHP',
						'version' => '1.2.0.x',
						'tag' => 'CakePHP Rocks!' 
				) ),
	...
	function testForwardsCompatibility() {
		...
		$this->assertEqual ( array (
				'name' => 'value' 
		), $this->Controller->Cookie->read ( 'JSON' ) );
