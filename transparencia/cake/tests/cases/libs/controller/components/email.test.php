...
TEMPDOC;
	...
	function testSmtpEhlo() {
		...
		$connection = & new CakeSocket ( array (
				'protocol' => 'smtp',
				'host' => 'localhost',
				'port' => 25 
		) );
...
TEMPDOC;
	...
	function testSmtpSendMultipleTo() {
		...
		$this->Controller->EmailTest->to = array (
		...
		$this->assertPattern ( '/To: postmaster@localhost, root@localhost[\n\r]/', $this->Controller->EmailTest->smtpSend );
	}
...
HTMLBLOC;
	...
	function testSmtpSendSocket() {
		...
		$this->Controller->EmailTest->smtpOptions ['timeout'] = 10;
		$socket = & new CakeSocket ( array_merge ( array (
				'protocol' => 'smtp' 
