...
class RouterTest extends CakeTestCase {
	...
	function testFullBaseURL() {
		...
		$this->assertPattern ( '/^http(s)?:\/\//', Router::url ( array (
				'full_base' => true 
		) ) );
		$this->assertIdentical ( FULL_BASE_URL . '/', Router::url ( array (
				'full_base' => true 
		) ) );
	}
	...
	function testRouteDefaultParams() {
		...
		$this->assertEqual ( Router::url ( array (
				'action' => 'index' 
		) ), '/' );
	}
	...
	function testResourceRoutes() {
		...
		$this->assertEqual ( $this->router->__resourceMapped, array (
				'posts' 
		) );
	...
	function testUrlGenerationWithAdminPrefix() {
		...
		Router::setRequestInfo ( array (
				...
				array (
						'base' => '',
						'here' => '/admin/registrations/index',
						'webroot' => '/' 
				) 
		) );
		...
		Router::setRequestInfo ( array (
				...
				array (
						'base' => '/magazine',
						'here' => '/magazine/admin/subscriptions/index/page:2',
						'webroot' => '/magazine/',
						'passedArgs' => array (
								'page' => 2 
						) 
		...
		Router::setRequestInfo ( array (
				...
				array (
						'base' => '/magazine',
						'here' => '/magazine/admin/subscriptions/edit/1',
						'webroot' => '/magazine/',
						'passedArgs' => array (
								'page' => 2 
						),
	...
	function testNamedArgsUrlParsing() {
		...
		Router::reload ();
		Router::connect ( '/foo/:action/*', array (
				'controller' => 'bar' 
		), array (
				'named' => array (
						'param1' => array (
	...
	function testCurrentRoute() {
		...
		$this->assertEqual ( array_merge ( $url, array (
				'plugin' => null 
		) ), $route->defaults );
	}
	/**
...
class CakeRouteTestCase extends CakeTestCase {
	...
	function testConstruction() {
		...
		$this->assertEqual ( $route->options, array (
				'id' => '[0-9]+' 
		) );
