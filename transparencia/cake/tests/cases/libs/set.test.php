...
class SetTest extends CakeTestCase {
	...
	function testNumericKeyExtraction() {
		...
		$this->assertIdentical ( Set::extract ( $data, '{n}' ), array (
				1,
				'whatever' 
		) );
		$this->assertIdentical ( Set::diff ( $data, Set::extract ( $data, '{n}' ) ), array (
				'plugin' => null,
				'controller' => '',
				'action' => '' 
		) );
	...
	function testExtractWithArrays() {
		...
		$this->assertEqual ( Set::extract ( '/Level1/Level2', $data ), array (
				array (
						'Level2' => array (
								'test1',
								'test2' 
		...
		$this->assertEqual ( Set::extract ( '/Level1/Level2bis', $data ), array (
				array (
						'Level2bis' => array (
								'test3',
								'test4' 
	...
	function testInsert() {
		...
		$result = Set::insert ( $a, 'pages.1.vars', array (
				'title' => 'page title' 
		) );
		$expected = array (
				'pages' => array (
	...
	function testMapReverse() {
		...
		$this->assertIdentical ( $ids, array (
				1,
				2 
		) );
