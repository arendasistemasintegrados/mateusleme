...
class PaginatorHelperTest extends CakeTestCase {
	 ...
	 */
	function setUp() {
		$this->Paginator = new PaginatorHelper ( array (
				'ajax' => 'Ajax' 
		) );
	...
	function testSortLinks() {
		...
		$result = $this->Paginator->sort ( array (
				'asc' => 'ascending',
				'desc' => 'descending' 
		), 'title' );
		$expected = array (
		...
		$this->Paginator->params ['paging'] ['Article'] ['options'] ['order'] = array (
				'Article.title' => 'desc' 
		);
	...
	function testSortLinksUsingDirectionOption() {
		...
		$result = $this->Paginator->sort ( 'TestTitle', 'title', array (
				'direction' => 'desc' 
		) );
		$expected = array (
				'a' => array (
	...
	function testPassedArgsMergingWithUrlOptions() {
		...
		$this->Paginator->params ['pass'] = array (
				2 
		);
		$this->Paginator->params ['named'] = array (
				'foo' => 'bar' 
		);
		...
		$expected = array (
				'a' => array (
						'href' => '/articles/index/2/page:1/foo:bar/sort:title/direction:asc' 
				),
				'Title',
				'/a' 
		);
		...
		$expected = array (
				...
				array (
						'a' => array (
								'href' => '/articles/index/2/page:2/foo:bar' 
						) 
				),
				'2',
				'/a',
				...
				array (
						'a' => array (
								'href' => '/articles/index/2/page:3/foo:bar' 
						) 
				),
				'3',
				'/a',
				...
				array (
						'a' => array (
								'href' => '/articles/index/2/page:4/foo:bar' 
						) 
				),
				'4',
				'/a',
				...
				array (
						'a' => array (
								'href' => '/articles/index/2/page:5/foo:bar' 
						) 
				),
				'5',
				'/a',
				...
				array (
						'a' => array (
								'href' => '/articles/index/2/page:6/foo:bar' 
						) 
				),
				'6',
				'/a',
				...
				array (
						'a' => array (
								'href' => '/articles/index/2/page:7/foo:bar' 
						) 
				),
				'7',
				'/a',
	...
	function testFirstAndLast() {
		...
		$expected = array (
				...
				array (
						'a' => array (
								'href' => FULL_BASE_URL . '/index/page:1/sort:Client.name/direction:DESC' 
						) 
				),
				'&lt;&lt; first',
				'/a',
	...
	function testMockAjaxProviderClassInjection() {
		$Paginator = & new PaginatorHelper ( array (
		...
		$result = $Paginator->link ( 'Page 2', array (
				'page' => 2 
		), array (
				'update' => '#content' 
		) );
