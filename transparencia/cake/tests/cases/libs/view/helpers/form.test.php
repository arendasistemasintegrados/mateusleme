...
class FormHelperTest extends CakeTestCase {
	...
	function testDuplicateFieldNameResolution() {
		...
		$this->assertEqual ( $this->View->entity (), array (
				'ValidateUser' 
		) );
	...
	function testFormSecuredMultipleSelect() {
		...
		$this->Form->fields = array ();
		$this->Form->select ( 'Model.select', $options, null, array (
				'multiple' => true 
		) );
		$this->assertEqual ( $this->Form->fields, $expected );
	}
	...
	function testFormValidationMultiRecord() {
		$this->Form->validationErrors ['Contact'] = array (
				2 => array (
	...
	function testTextbox() {
		...
		$result = $this->Form->text ( 'Model.text', array (
				'id' => 'theID' 
		) );
		$this->assertTags ( $result, array (
				'input' => array (
	...
	function testError() {
		...
		$result = $this->Form->error ( 'Model.field', 'There is an error fool!', array (
				'wrap' => 'span' 
		) );
		$this->assertTags ( $result, array (
				'span' => array (
		...
		$result = $this->Form->error ( 'Model.field', "<strong>Badness!</strong>", array (
				'wrap' => false 
		) );
	...
	function testPassword() {
		...
		$result = $this->Form->password ( 'Model.passwd', array (
				'id' => 'theID' 
		) );
		$this->assertTags ( $result, array (
				'input' => array (
						'type' => 'password',
						'name' => 'data[Model][passwd]',
						'value' => 'test',
						'id' => 'theID',
						'class' => 'form-error' 
				) 
	...
	function testRadio() {
		...
		$result = $this->Form->input ( 'Newsletter.subscribe', array (
				'legend' => 'Legend title',
				'type' => 'radio',
				'options' => array (
						'0' => 'Unsubscribe',
	...
	function testSelectOptionGroupEscaping() {
		...
		$result = $this->Form->select ( 'Model.field', $options, null, array (
				'empty' => false 
		) );
		$expected = array (
				'select' => array (
	...
	function testSelectMultiple() {
		...
		$result = $this->Form->select ( 'Model.multi_field', $options, null, array (
				'multiple' => true 
		) );
		$expected = array (
				'input' => array (
	...
	function testCheckbox() {
		...
		$result = $this->Form->checkbox ( 'Contact.name', array (
				'value' => 'myvalue' 
		) );
		$expected = array (
				'input' => array (
	...
	function testDateTime() {
		...
		$result = $this->Form->dateTime ( 'Contact.date', 'DMY', '12', null, array (
				'empty' => false 
		) );
		$now = strtotime ( 'now' );
		$expected = array (
		...
		$result = $this->Form->dateTime ( 'Model.field', 'DMY', '12', null, array (
				'empty' => false 
		) );
		$expected = array (
				array (
		...
		$expected = array (
				...
				'label' => array (
						'for' => 'ContactPublishedHour' 
				),
				'Published',
				'/label',
				array (
						'select' => array (
								'name' => 'data[Contact][published][hour]',
	...
	function testMonth() {
		...
		$result = $this->Form->month ( 'Model.field', null, array (
				'empty' => true 
		) );
		$expected = array (
				array (
	...
	function testMinute() {
		...
		$this->Form->data ['Model'] ['field'] = '';
		$result = $this->Form->minute ( 'Model.field', null, array (
				'interval' => 5 
		) );
		$expected = array (
				array (
	...
	function testYear() {
		...
		$result = $this->Form->year ( 'Model.field', 2006, 2007, null, array (
				'orderYear' => 'asc' 
		) );
		$expected = array (
				array (
		...
		$result = $this->Form->year ( 'Contact.published', 2006, 2007, null, array (
				'class' => 'year' 
		) );
		$expected = array (
				array (
		...
		$this->Form->data ['Contact'] ['published'] = '2006-10-10';
		$result = $this->Form->year ( 'Contact.published', 2006, 2007, false, array (
				'empty' => false 
		) );
		$expected = array (
				array (
		...
		$this->Form->data ['Contact'] ['published'] = '2006-10-10';
		$result = $this->Form->year ( 'Contact.published', 2006, 2007, 2007, array (
				'empty' => false 
		) );
		$expected = array (
				array (
		...
		$this->Form->data ['Contact'] ['published'] = '';
		$result = $this->Form->year ( 'Contact.published', 2006, 2008, 2007, array (
				'empty' => false 
		) );
		$expected = array (
				array (
		...
		$this->Form->data ['Contact'] ['published'] = '2006-10-10';
		$result = $this->Form->year ( 'Contact.published', 2006, 2008, null, array (
				'empty' => false 
		) );
		$expected = array (
				array (
		...
		$this->Form->data = array ();
		$this->Form->create ( 'Contact' );
		$result = $this->Form->year ( 'published', 2006, 2008, null, array (
				'empty' => false 
		) );
		$expected = array (
				array (
	...
	function testHiddenField() {
		$this->Form->validationErrors ['Model'] ['field'] = 1;
		$this->Form->data ['Model'] ['field'] = 'test';
		$result = $this->Form->hidden ( 'Model.field', array (
				'id' => 'theID' 
		) );
		$this->assertTags ( $result, array (
				'input' => array (
	...
	function testFileUploadField() {
		...
		$this->Form->data ['Model.upload'] = array (
				"name" => "",
				"type" => "",
				"tmp_name" => "",
				"error" => 4,
	...
	function testCreateWithMultipleIdInData() {
		...
		$this->Form->data ['Contact'] ['id'] = array (
				1,
				2 
		);
		$result = $this->Form->create ( 'Contact' );
	...
	function testEditFormWithData() {
		...
		$this->Form->create ();
		$result = $this->Form->select ( 'People.People', $options, null, array (
				'multiple' => true 
		) );
		$expected = array (
				'input' => array (
