...
class ConnectionManagerTest extends CakeTestCase {
	...
	function testGetPluginDataSourceAndLocalDriver() {
		App::build ( array (
				...
				'datasources' => array (
						TEST_CAKE_CORE_INCLUDE_PATH . 'tests' . DS . 'test_app' . DS . 'models' . DS . 'datasources' . DS 
				) 
		) );
	...
	function testLoadDataSource() {
		$connections = array (
				...
				array (
						'classname' => 'DboMysqli',
						'filename' => 'dbo' . DS . 'dbo_mysqli' 
				),
				array (
						'classname' => 'DboMssql',
						'filename' => 'dbo' . DS . 'dbo_mssql' 
				),
				array (
						'classname' => 'DboOracle',
						'filename' => 'dbo' . DS . 'dbo_oracle' 
				) 
		);
	...
	function testConnectionData() {
		...
		ConnectionManager::create ( 'connection7', array (
				'datasource' => 'TestPlugin.TestOther' 
		) );
		$connections = ConnectionManager::enumConnectionObjects ();
