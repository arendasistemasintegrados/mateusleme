...
class XmlTest extends CakeTestCase {
	...
	function testSimpleArrayWithZeroValues() {
		...
		$xml = new Xml ( $data, array (
				'format' => 'tags' 
		) );
		$result = $xml->toString ( array (
				'format' => 'tags',
				'header' => false 
		) );
	...
	/**
	 * Tests that XML documents with non-standard spacing (i.e.
	 * leading whitespace, whole document
	...
	function testSetSerialization() {
		...
		$xml = new Xml ( Set::map ( $input ), array (
				'format' => 'tags' 
		) );
		$result = $xml->toString ( array (
				'header' => false,
	...
	function testElementCollapsing() {
		...
		$this->assertEqual ( count ( $result ['resultpackage'] ['result'] ), count ( $expected ['resultpackage'] ['result'] ), 'Incorrect array length %s' );
		
		$this->assertFalse ( isset ( $result ['resultpackage'] ['result'] [0] [0] ['qid'] ), 'Nested array exists, data is corrupt. %s' );
						...
						'Channel' => array (
								...
								'Item' => array (
										array (
												...
												'guid' => array (
														'isPermaLink' => 'true',
														'value' => 'http://groups.google.com/group/cake-php/msg/49bc00f3bc651b4f' 
												),
										...
										array (
												...
												'guid' => array (
														'isPermaLink' => 'true',
														'value' => 'http://groups.google.com/group/cake-php/msg/8b350d898707dad8' 
												),
	...
	function testCamelize() {
		$xmlString = '<methodCall><methodName>examples.getStateName</methodName>' . '<params><param><value><i4>41</i4></value></param></params></methodCall>';
