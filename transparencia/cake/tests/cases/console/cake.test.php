...
class ShellDispatcherTest extends CakeTestCase {
	...
	function testDispatchShellWithMain() {
		Mock::generate ( 'Shell', 'MockWithMainShell', array (
				'main',
				'_secret' 
		) );
	...
	function testDispatchShellWithoutMain() {
		Mock::generate ( 'Shell', 'MockWithoutMainShell', array (
				'initDb',
				'_secret' 
		) );
	...
	function testDispatchNotAShellWithMain() {
		Mock::generate ( 'Object', 'MockWithMainNotAShell', array (
				'main',
				'initialize',
				'loadTasks',
				'startup',
	...
	function testDispatchNotAShellWithoutMain() {
		Mock::generate ( 'Object', 'MockWithoutMainNotAShell', array (
				'initDb',
				'initialize',
				'loadTasks',
				'startup',
	...
	function testDispatchTask() {
		Mock::generate ( 'Shell', 'MockWeekShell', array (
				'main' 
		) );
		Mock::generate ( 'Shell', 'MockOnSundayTask', array (
				'execute' 
		) );
