...
Mock::generatePartial ( 'ShellDispatcher', 'TestTestTaskMockShellDispatcher', array (
		'getInput',
		'stdout',
		'stderr',
		'_stop',
...
Mock::generatePartial ( 'TestTask', 'MockTestTask', array (
		'in',
		'_stop',
		'err',
		'out',
...
class TestTaskTest extends CakeTestCase {
	...
	function testExecuteWithOneArg() {
		...
		$this->Task->expectAt ( 0, 'createFile', array (
				'*',
				new PatternExpectation ( '/class TestTaskTagTestCase extends CakeTestCase/' ) 
		) );
		$this->Task->execute ();
	}
