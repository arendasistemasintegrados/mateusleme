...
Mock::generatePartial ( 'ShellDispatcher', 'TestProjectTaskMockShellDispatcher', array (
		'getInput',
		'stdout',
		'stderr',
		'_stop',
...
Mock::generatePartial ( 'ProjectTask', 'MockProjectTask', array (
		'in',
		'_stop',
		'err',
		'out',
...
class ProjectTaskTest extends CakeTestCase {
	...
	function testCakeAdmin() {
		...
		$this->assertEqual ( Configure::read ( 'Routing.prefixes' ), array (
				'my_prefix' 
		) );
		$file->delete ();
	}
