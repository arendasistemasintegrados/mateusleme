...
Mock::generatePartial ( 'ShellDispatcher', 'TestTemplateTaskMockShellDispatcher', array (
		'getInput',
		'stdout',
		'stderr',
		'_stop',
...
Mock::generatePartial ( 'TemplateTask', 'MockTemplateTask', array (
		'in',
		'out',
		'err',
		'createFile',
...
class TemplateTaskTest extends CakeTestCase {
	...
	function testFindingInstalledThemesForBake() {
		...
		$this->assertEqual ( $this->Task->templatePaths, array (
				'default' => $consoleLibs . 'templates' . DS . 'default' . DS 
		) );
	}
