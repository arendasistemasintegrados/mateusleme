...
Mock::generatePartial ( 'ShellDispatcher', 'TestExtractTaskMockShellDispatcher', array (
		'getInput',
		'stdout',
		'stderr',
		'_stop',
...
class ExtractTaskTest extends CakeTestCase {
	...
	function testExtractMultiplePaths() {
		...
		$this->Task->params ['paths'] = TEST_CAKE_CORE_INCLUDE_PATH . 'tests' . DS . 'test_app' . DS . 'views' . DS . 'pages,' . TEST_CAKE_CORE_INCLUDE_PATH . 'tests' . DS . 'test_app' . DS . 'views' . DS . 'posts';
