...
class ShellTest extends CakeTestCase {
	...
	function testInitialize() {
		App::build ( array (
				...
				'models' => array (
						TEST_CAKE_CORE_INCLUDE_PATH . 'tests' . DS . 'test_app' . DS . 'models' . DS 
				) 
		), true );
	...
	function testIn() {
		...
		$this->Shell->Dispatch->expectAt ( 0, 'getInput', array (
				'Just a test?',
				array (
						'y',
						'n' 
		...
		$this->Shell->Dispatch->expectAt ( 1, 'getInput', array (
				'Just a test?',
				array (
						'y',
						'n' 
		...
		$this->Shell->Dispatch->expectAt ( 2, 'getInput', array (
				'Just a test?',
				'y,n',
				'n' 
		) );
		...
		$this->Shell->Dispatch->expectAt ( 3, 'getInput', array (
				'Just a test?',
				'y/n',
				'n' 
		) );
		...
		$this->Shell->Dispatch->expectAt ( 4, 'getInput', array (
				'Just a test?',
				'y',
				'y' 
		) );
		...
		$this->Shell->Dispatch->expectAt ( 5, 'getInput', array (
				'Just a test?',
				array (
						0,
						1,
	 ...
	 */
	function testOut() {
		$this->Shell->Dispatch->expectAt ( 0, 'stdout', array (
				"Just a test\n",
				false 
		) );
		$this->Shell->out ( 'Just a test' );
		
		$this->Shell->Dispatch->expectAt ( 1, 'stdout', array (
				"Just\na\ntest\n",
				false 
		) );
		...
		$this->Shell->Dispatch->expectAt ( 2, 'stdout', array (
				"Just\na\ntest\n\n",
				false 
		) );
		$this->Shell->out ( array (
	 ...
	 */
	function testErr() {
		$this->Shell->Dispatch->expectAt ( 0, 'stderr', array (
				"Just a test\n" 
		) );
		$this->Shell->err ( 'Just a test' );
		
		$this->Shell->Dispatch->expectAt ( 1, 'stderr', array (
				"Just\na\ntest\n" 
		) );
		...
		$this->Shell->Dispatch->expectAt ( 2, 'stderr', array (
				"Just\na\ntest\n\n" 
		) );
		$this->Shell->err ( array (
				'Just',
	...
	function testHr() {
		...
		$this->Shell->Dispatch->expectAt ( 4, 'stdout', array (
				$bar . "\n",
				false 
		) );
