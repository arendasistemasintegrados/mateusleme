...
class CakeBaseReporter extends SimpleReporter {
	...
	/**
	 * Signals/Paints the end of a TestSuite.
	 * All test cases have run
	...
	/**
	 * Paints the beginning of a test method being run.
	 * This is used
	 * to start/resume the code coverage tool.
	 *
	 * @param string $method
	 *        	The method name being run.
	 * @return void
	 */
	...
	/**
	 * Paints the end of a test method being run.
	 * This is used
	 ...
	 * Similar to getMicrotime in basics.php
