...
class Dispatcher extends Object {
	 ...
	 *        	Set to true if missing action should be rendered, false otherwise
	...
	/**
	 * Returns array of GET and POST parameters.
	 * GET parameters are taken from given URL.
	 *
