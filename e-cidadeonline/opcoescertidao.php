 ...
 *                            www.arendasistemas.com.br                     
 *                         arenda@arendasistemas.com.br                   
 *                                                                    
...
if (pg_num_rows($result) > 0) {
	//db_fieldsmemory ( $result, 0 ); //lmachado Data: 05/06/15 13:50 Motivo: alteração devido ao erro encontrado pelo TiagoSalvador.Ajuste etapa 02
	if (@$codigo_cgm == "")
