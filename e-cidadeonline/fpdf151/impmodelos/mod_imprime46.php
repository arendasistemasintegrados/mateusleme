...
/**
 * OBS.: Caso encontrar a seguinte condição no código: "if ($iCodCli == 11)",
 * este trecho do código significa que o cliente 11 (Alegrete) solicitou um 
 * layout exclusivo.
 */

$iInstituicao = db_getsession("DB_instit");
$sSqlCodCli   = " select db21_codcli as codcli                  ";
$sSqlCodCli  .= "   from db_config where codigo = $iInstituicao ";
$rsCodCli     = db_query($sSqlCodCli);
$iCodCli      = db_utils::fieldsMemory($rsCodCli, 0)->codcli;
...
if($this->w_dmedic > 0){
  ...
  if ($iCodCli == 11){
    $this->objpdf->cell(160,$alt,'(92.829.100/0001-43) - INSTITUTO DE PREVIDÊNCIA DO ESTADO DO RS','LTB',0,'L',0);
  } else {
