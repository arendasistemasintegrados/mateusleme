...
class Contribuinte_Model_ContribuinteAbstract {
   ...
   * @var integer
   */
  private $iOptanteSimplesCategoria;
  ...
  */
   ...
   * @param DateTime $dDataInscricaogetOptanteSimplesCategoria
   */
  ...
  */
  ...
  public function getOptanteSimplesCategoria() {
    return $this->iOptanteSimplesCategoria;
  }
  
  /**
   * Define a categoria do Optante Simples Nacional 
   * @param integer $iOptanteSimplesCategoria
   */
  public function setOptanteSimplesCategoria($sOptanteSimplesCategoria = NULL) {
    $this->iOptanteSimplesCategoria = (int) $sOptanteSimplesCategoria;
  }
}