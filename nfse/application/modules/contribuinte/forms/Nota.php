...
class Contribuinte_Form_Nota extends Twitter_Bootstrap_Form_Horizontal {
   ...
   * @var string
   */
  private $sAction = '/contribuinte/nota/index';
   ...
   */
  public function __construct($sCodigoVerificacao, $dMenorDiaEmissao, $sAction = '/contribuinte/nota/index',
                              $lRps = FALSE) {
  ...
  public function init() {
    ...
    if ($this->sCodigoVerificacao == NULL) {
      ...
      $this->addElement(new Twitter_Bootstrap_Form_Element_Button('nova', array(
        'label'      => 'Nova',
        'type'       => 'button',
        'url'        => $oBaseUrlHelper->baseUrl('/contribuinte/nota/index/'),
        'buttonType' => Twitter_Bootstrap_Form_Element_Button::BUTTON_SUCCESS
      )));
      ...
      $this->addElement(new Twitter_Bootstrap_Form_Element_Button('imprimir', array(
        'label'      => 'Imprimir',
        'type'       => 'button',
        'url'        => $oBaseUrlHelper->baseUrl("/contribuinte/nota/nota-impressa/cod/{$this->sCodigoVerificacao}"),
        'buttonType' => Twitter_Bootstrap_Form_Element_Button::BUTTON_SUCCESS
      )));
