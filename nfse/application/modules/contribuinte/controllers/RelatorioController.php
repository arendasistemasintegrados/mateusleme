...
class Contribuinte_RelatorioController extends Contribuinte_Lib_Controller_AbstractController {
  ...
  private static function getSqlRelatorio2($lGuiaEmitida = FALSE) {
    $sGuiaEmitida = $lGuiaEmitida ? ' IS NOT NULL ' : ' IS NULL ';
...
servico_prestado.servico_valor_iss AS prestador_valor_iss ,
servico_prestado.servico_iss_retido AS prestador_iss_retido ,
servico_prestado.tomador_cnpjcpf AS tomador_cnpjcpf ,
servico_prestado.tomador_razao_social AS tomador_razao_social ,
servico_prestado.tomador_inscricao_municipal AS tomador_inscricao_municipal ,
servico_prestado.prestador_endereco_uf AS tomador_endereco_uf ,
servico_tomado_municipio.nome AS tomador_endereco_municipio ,
servico_prestado.tomador_contato_telefone AS tomador_contato_telefone ,
servico_prestado.documento_numero AS tomador_documento_numero ,
servico_prestado.documento_data AS tomador_documento_data ,
servico_prestado.documento_tipo AS tomador_documento_tipo ,
servico_prestado.servico_valor_servicos AS tomador_valor_servico ,
servico_prestado.servico_valor_aliquota AS tomador_valor_aliquota ,
servico_prestado.servico_valor_iss AS tomador_valor_iss ,
servico_prestado.servico_iss_retido AS tomador_iss_retido 
FROM view_nota_mais_dms servico_prestado 
LEFT JOIN municipios servico_tomado_municipio ON ( servico_prestado.tomador_endereco_municipio_codigo || '' = servico_tomado_municipio.cod_ibge) 
LEFT JOIN municipios servico_prestado_municipio ON ( servico_prestado.prestador_endereco_municipio_codigo || '' = servico_prestado_municipio.cod_ibge) 
LEFT JOIN guias_notas servico_prestador_guia_numpre ON ( servico_prestador_guia_numpre.id_nota = servico_prestado.documento_id) 
WHERE 
servico_prestado.documento_classe = 'nfse' 
AND servico_prestado.documento_competencia_mes = ?
AND servico_prestado.documento_competencia_ano = ? 
...
AND (servico_prestado.documento_status_cancelamento = FALSE 
OR servico_prestado.documento_status_cancelamento IS NULL)
AND servico_prestado.documento_numero IS NOT NULL 
AND servico_prestador_guia_numpre.id_guia {$sGuiaEmitida}

UNION 

SELECT servico_tomados.prestador_cnpjcpf AS prestador_cnpjcpf ,
servico_tomados.prestador_razao_social AS prestador_razao_social ,
servico_tomados.prestador_inscricao_municipal AS prestador_inscricao_municipal ,
servico_tomados.prestador_endereco_uf AS prestador_endereco_uf ,
servico_prestado_municipio.nome AS prestador_endereco_municipio ,
servico_tomados.prestador_contato_telefone AS prestador_contato_telefone ,
servico_tomados.documento_numero AS prestador_documento_numero ,
servico_tomados.documento_data AS prestador_documento_data ,
servico_tomados.documento_tipo AS prestador_documento_tipo ,
servico_tomados.servico_valor_servicos AS prestador_valor_servico ,
servico_tomados.servico_valor_aliquota AS prestador_valor_aliquota ,
servico_tomados.servico_valor_iss AS prestador_valor_iss ,
servico_tomados.servico_iss_retido AS prestador_iss_retido ,
servico_tomados.tomador_cnpjcpf AS tomador_cnpjcpf ,
servico_tomados.tomador_razao_social AS tomador_razao_social ,
servico_tomados.tomador_inscricao_municipal AS tomador_inscricao_municipal ,
servico_tomados.prestador_endereco_uf AS tomador_endereco_uf ,
servico_tomado_municipio.nome AS tomador_endereco_municipio ,
servico_tomados.tomador_contato_telefone AS tomador_contato_telefone ,
servico_tomados.documento_numero AS tomador_documento_numero ,
servico_tomados.documento_data AS tomador_documento_data ,
servico_tomados.documento_tipo AS tomador_documento_tipo ,
servico_tomados.servico_valor_servicos AS tomador_valor_servico ,
servico_tomados.servico_valor_aliquota AS tomador_valor_aliquota ,
servico_tomados.servico_valor_iss AS tomador_valor_iss ,
servico_tomados.servico_iss_retido AS tomador_iss_retido
FROM view_nota_mais_dms servico_tomados 
LEFT JOIN municipios servico_tomado_municipio ON ( servico_tomados.tomador_endereco_municipio_codigo || '' = servico_tomado_municipio.cod_ibge) 
LEFT JOIN municipios servico_prestado_municipio ON ( servico_tomados.prestador_endereco_municipio_codigo || '' = servico_tomado_municipio.cod_ibge) 
LEFT JOIN guias_notas servico_tomador_guia_numpre ON ( servico_tomador_guia_numpre.id_nota = servico_tomados.documento_id) 
WHERE 
servico_tomados.documento_classe = 'dms' 
AND servico_tomados.documento_competencia_mes = ?
AND servico_tomados.documento_competencia_ano = ? 
AND servico_tomados.tomador_cnpjcpf = ?
AND servico_tomados.documento_id_nota_substituta IS NULL 
AND (servico_tomados.documento_status_cancelamento = FALSE 
OR servico_tomados.documento_status_cancelamento IS NULL)
AND servico_tomados.documento_numero IS NOT NULL 
AND servico_tomador_guia_numpre.id_guia {$sGuiaEmitida} ";
  }
}